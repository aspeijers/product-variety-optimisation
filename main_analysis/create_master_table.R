##################################################################################################
######## Description: Creatng the master table without market shares     
######## input: product_store_timeline.RData, sales.RData, product.RData, stores.RData
######## output: master_datasplitting.RData
################################################################################################## 
