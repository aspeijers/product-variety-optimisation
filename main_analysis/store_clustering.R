##################################################################################################
######## Description: Convert all variables in the master table to dummy variables for each store
########              Cluster the stores based on various subsets of these variables
######## input: master_mktshare.RData 
######## output: clusterings_2.RData, stores_dummies_mktshareshelf.RData, 
########        stores_dummies_mktsales.RData 
##################################################################################################
