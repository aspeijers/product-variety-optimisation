##################################################################################################
######## Description: this ranks the products by their predicted mkt share and returns the  
########              suggested products; no substitution effects included
########              finding the differences between the original and the recommended vareity
######## input: master_mktshare.RData; predicted_mktshare.RData
######## output: suggestions.RData; product_differences.RData
##################################################################################################
