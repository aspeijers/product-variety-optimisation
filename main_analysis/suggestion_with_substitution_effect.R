##################################################################################################
######## Description: this file takes into acctount both the suggestions and 
########              the substitution effects
######## input: product_differences.RData;suggestions.RData; predicted_mktshare.RData;
########        substitutes.RData; master_mktshare.RData   
######## output: new_prod_subs_insp.RData; new_prod_subs_treat.RData
##################################################################################################
