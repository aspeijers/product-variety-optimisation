##################################################################################################
######## Description: Creating substitute statistics regarding the recommended variety     
######## input: suggestions.RData, master_mktshare.RData, new_prod_subs_insp.RData, 
########        new_prod_subs_treat.RData
######## output: 
##################################################################################################
