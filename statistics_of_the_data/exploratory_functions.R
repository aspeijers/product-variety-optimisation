##################################################################################################
######## Description: graph functions to help explore the data; smooting sales over months  
######## input: products.RData, sales.RData, stores.RData,master_mktshare.RData
######## output: sales_by_month.RData
##################################################################################################
...
library(ggplot2)
library(data.table)
master_table <- readRDS("master_mktshare.RData")
