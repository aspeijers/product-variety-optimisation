...
# USE THE NEW DATA
assortment_date = readRDS("/home/didi/BGSE/semester3/kernel/data/product_store_timeline_total_days.RData")
#assortment_date <- readRDS("product_store_timeline_total_days.RData")
names(assortment_date)[3] <- "days_in_assort"
#Deni: I don't know why but i have 2 columns total_days so i will drop one
#assortment_date[,total_days:=NULL]
...
saveRDS(master_table, file="/home/didi/BGSE/semester3/kernel/data/master_table.RData")
